...
def mass_truth_assignment_eval(
    ...
    for i in range(0, len(statements), batch_size):
        ...
        if model_family == 'llama':
            ...
            batch_prompts = [
                f"Determine whether the following statement is factually correct. Respond with exactly one of: True, False, Unknown. Answer Unknown unless you are certain. Statement: {stmt} Answer:".rstrip()
                for stmt in batch_statements
            ]
