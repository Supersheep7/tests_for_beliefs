...
def run_intervention():
    ...
    if sweep:
        while True:
            ...
            # Trues
            print("True --> False...")
            boolp_t, probdiff_t = parameter_sweep(model_baseline=model, prompts=x_true, accuracies=accuracies, directions=directions, ks=k_list, alphas=alpha_list_flipped, metric='boolp', labels=y_true, attn=modality=='heads')
            print(boolp_t)
            print(probdiff_t)
            # Falses
            print("False --> True...")
            print(boolp_f)
            print(probdiff_f)
            boolp_f, probdiff_f = parameter_sweep(model_baseline=model, prompts=x_false, accuracies=accuracies, directions=directions, ks=k_list, alphas=alpha_list, metric='boolp', labels=y_false, attn=modality=='heads')
    ...
    # Trues
    boolp, probdiff = parameter_sweep(model_baseline=model, prompts=x_true, accuracies=accuracies, directions=directions, ks=k_list_flipped, alphas=alpha_list_flipped, metric='boolp', labels=y_true, attn=modality=='heads')
    ...
    # Falses
    boolp, probdiff = parameter_sweep(model_baseline=model, prompts=x_true, accuracies=accuracies, directions=directions, ks=k_list, alphas=alpha_list_flipped, metric='boolp', labels=y_true, attn=modality=='heads')
